...
import { addFeedbackComment } from "@/lib/actions/feedback-actions";
...
export function FeedbackComments({ feedbackId, comments }: { feedbackId: string; comments: Comment[] }) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    startTransition(async () => {
      const result = await addFeedbackComment(feedbackId, content.trim());
      if (result.success) {
        setContent("");
        router.refresh();
      }
